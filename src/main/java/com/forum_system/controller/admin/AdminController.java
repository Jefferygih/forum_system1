...
import com.forum_system.service.AdminService;
...
public class AdminController {
    ...
    public String loginPage(Model model, @RequestParam(value = "from", defaultValue = "/admin/index") String from) {
    ...
    public String login(Model model, Admin admin, HttpServletResponse response, HttpSession session,
                        @RequestParam(value = "from", defaultValue = "/admin/index") String from,
